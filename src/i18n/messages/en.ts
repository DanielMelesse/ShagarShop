export const en = {
  ...
  checkout: {
    ...
    payNowWithTotal: "Pay now · {total}",
    placingOrder: "Placing order...",
    redirectingPayment: "Redirecting to payment...",
    orderPlaced: "Order placed!",
    thankYou: "Thank you{name}.",
    thankYouPaid: "Thank you{name}. Your payment was received.",
    thankYouCod: "Thank you{name}. Pay the courier in cash when your order arrives.",
    amountPaid: "Amount: {total}",
    orderRef: "Order {id}",
    confirmingPayment: "Confirming your payment…",
    paymentFailedTitle: "Payment not completed",
    paymentFailed: "We could not confirm your payment. You were not charged for an incomplete checkout.",
    paymentMissingRef: "Missing payment reference.",
    ...
    payWithTelebirrHint:
      "Pay on Ethio Telecom Telebirr checkout (H5) — your own merchant account.",
    telebirrPhone: "Telebirr phone number",
    telebirrPhoneHint: "Use the number registered on your Telebirr wallet.",
    telebirrWaitingTitle: "Waiting for Telebirr",
    telebirrWaitingBody:
      "Finish payment in Telebirr, then this page will confirm automatically.",
    telebirrWaitingHint: "Checking payment… attempt {count}",
    telebirrTimeout:
      "We have not confirmed payment yet. If you already paid, tap check again.",
    telebirrCheckAgain: "Check payment again",
    payWithChapa: "Pay with Chapa",
    payWithChapaHint: "Pay on Chapa checkout — banks, cards, and Chapa wallets.",
    payWithCod: "Cash on delivery",
    payWithCodHint: "Pay the courier in cash when your package arrives.",
